...
\hypertarget{ux6d41ux7a0bux5206ux6790ux6cd5}{%
\subsection{流程分析法}\label{ux6d41ux7a0bux5206ux6790ux6cd5}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  使用流程分析法可以测试一些与流程有关的功能点,在具体测试用例设计时还可使用等价类、边界值等方法:
...
\tightlist
\item
  与权限有关的测试特征可以暂定使用状态转换测试法进行测试,如下:
