...
# 方法
## 流程分析法
1. 使用流程分析法可以测试一些与流程有关的功能点,在具体测试用例设计时还可使用等价类、边界值等方法:
    - 主持人创建项目
    - 主持人新建考题
    - 主持人设置考题期限
    - 主持人修改状态(开始-编写)
...
## 与权限有关的测试方法
1. 与权限有关的测试特征可以暂定使用状态转换测试法进行测试,如下:
    - 质管员再审权限
    - 有权限用户查阅考题
    - 评审员评审权限
    - 作者修改权限
...
## 用户管理测试方法
1. 与用户信息有关的特征可以使用等价类/边界值进行测试,如下:
    - 用户登录校验
    - 用户修改个人信息
...
# 风险以及应急措施
## 项目风险评估(NA、L、M、H刻画级别,由低到高,级别\*权值=分数)
### 结构化风险评估
#### 现存系统的变化频率
+ 级别: (M=2)-每年2到10次
+ 权值: 3
