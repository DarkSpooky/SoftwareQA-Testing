...
本次作业为软件质量保障与测试课程的Lab5课程作业，需要我们以小组为单位完成对出题系统的性能测试。本文档分为两小节。第一小节介绍了本小组进行性能测试采用的策略；第二小节介绍了性能测试的结果及系统性能分析。
...
# 测试策略
采用并发测试的策略，100个登录请求，20个创建考题请求（timer同步？）


# 系统性能及测试结果分析
满意度的曲线，如果时间较平稳可以推出有可扩展性？
